...
- **PARTITION BY** — делит данные на группы (партиции), внутри которых работает оконная функция
...
**ROUND в SQL** — это функция округления чисел.

ROUND(number, decimal_places)

**VIEW** — виртуальная таблица, не хранит данные, всегда показывает актуальное.

**MATERIALIZED VIEW** — физическая таблица с сохранёнными результатами запроса, требует обновления, но работает быстрее.
