...
эффективную работу с Garbage Collection**.
...
Если в Flink используется **Stateful Processing**, состояние данных сохраняется в памяти или во внешнем хранилище.
По умолчанию Flink хранит состояние в **JVM Heap**, но для больших данных рекомендуется **RocksDB**.
