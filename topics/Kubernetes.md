...
- **Automatic container management** – **K8s** управляет контейнерами (**Docker**) и балансирует нагрузку
- **Scaling** – **Kubernetes** может автоматически **увеличивать или уменьшать количество Pod’ов**.
- **Fault tolerance** – если **Pod падает**, **K8s** автоматически его **перезапускает**.
- **Flexibility** – можно развернуть сервисы на **AWS, GCP, Azure** или **bare metal**.
...
- selector находит Pod’ы с лейблом app: my-app.
- Запросы на my-service:80 перенаправляются на Pod:8080.
