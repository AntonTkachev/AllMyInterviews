...
![Иллюстрация к проекту](../img/JDK_JRE_JVM.png)

JDK (Java Development Kit):

Включает в себя компилятор, стандартные библиотеки классов Java, примеры, документацию, утилиты и JRE.
...
Выполняет байт-код Java, который генерируется компилятором Java (javac) из исходного кода программы.
